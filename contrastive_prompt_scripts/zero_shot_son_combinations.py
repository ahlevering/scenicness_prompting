    ...
    for ctx in exp_params['hyperparams']['prompts']['contexts']:
        ...
        for pos in exp_params['hyperparams']['prompts']['positive']:
            for neg in exp_params['hyperparams']['prompts']['negative']:
                ...
                inputs = processor(text=prompts, images=image, padding="max_length", return_tensors="pt")#.to("cuda:0")
...
results_df.to_csv("data/outputs/contrastive/zero_shot_contrasts_25.csv", header=True)
