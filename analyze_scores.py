...
# Read the data files
late_2 = gpd.read_file("data/outputs/minimum_2.geojson")
...
late_2 = late_2.rename(columns={"id": "ID", "pred": "preds"})
late_2 = late_2[["ID", "preds"]]

# Merge the dataframes
corine_pts = corine_pts.merge(late_2.rename(columns={"preds": "late_2"}), on="ID")
...
prediction_columns = ["Average", "late_2"]
