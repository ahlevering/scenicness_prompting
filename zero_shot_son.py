...
from codebase.pt_funcs.models_zero_shot import SONCLIPNet, CLIPZeroShotModel
...
##### LOAD SET-UP FILE #####
setup_file = "setup_files/train/son_zero_shot.yaml"
