...
results_path_25 = "data/outputs/contrastive/zero_shot_contrasts_25.csv"
results_path_full = "data/outputs/contrastive/zero_shot_contrasts_all.csv"
...
data = {
    ...
    "RMSE": [1.228, 1.249, 1.159, 1.064, 1.042, 1.138, 1.082, 1.002, 0.957, 0.913, 0.8432],
    "R2": [0.641, 0.632, 0.694, 0.747, 0.761, 0.724, 0.761, 0.779, 0.804, 0.822, 0.8506],
    "Tau": [0.465, 0.453, 0.508, 0.550, 0.561, 0.470, 0.520, 0.565, 0.603, 0.620, 0.651],
}
...
for ax in axes:
    ...
    ax.set_xticklabels(samples, rotation=0, ha="center", fontsize="small")
...
labels.insert(0, "ConvNeXt-L (full dataset)")
