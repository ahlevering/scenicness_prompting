...
def setup_transforms(transform_cmds):
    ...
    if 'size' in transform_cmds:
        if 'resize' in transform_cmds['size']:
            size = transform_cmds['size']['resize']['size']
    ...
    if 'normalize' in transform_cmds:
        compose_list.append(transforms.Normalize(
                                                transform_cmds['normalize']['mean'],
                                                transform_cmds['normalize']['std']))
